...
//  std::cout<<std::endl<<"the function makeSpecific is called"<< std::endl<<std::endl;
...
//    std::cout<<std::endl<<"loop_index: "<< loop_index << std::endl;
    loop_index++;
...
/*
      std::cout<<"particle ID: "<< candidate->pdgId ()
               <<" status: "<< candidate->status() 
	       <<" energy: "<< e
	       <<" pt: " << candidate->pt() 
	       <<" eta: "<< candidate->eta() 
	       <<" phi: "<< candidate->phi()<<std::endl;
*/      
...
/*
  std::cout<<std::endl<<"outside the loop"<<std::endl;
  std::cout<< "m_ChEmEnergy: "<< genJetSpecific->m_ChEmEnergy 
           <<" m_NeEmEnergy: "<< genJetSpecific->m_NeEmEnergy
           <<" m_EmEnergy: "  << genJetSpecific->m_EmEnergy
           <<" m_ChHadEnergy: "<< genJetSpecific->m_ChHadEnergy
           <<" m_NeHadEnergy: "<< genJetSpecific->m_NeHadEnergy
           <<" m_HadEnergy: "  << genJetSpecific->m_HadEnergy
           <<" m_MuEnergy: "  << genJetSpecific->m_MuEnergy
           <<" m_InvisibleEnergy: "  << genJetSpecific->m_InvisibleEnergy
           <<" m_AuxiliaryEnergy: "  << genJetSpecific->m_AuxiliaryEnergy 
           <<std::endl;
*/
